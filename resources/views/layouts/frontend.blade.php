...
<head>
    ...
    <title>Jahid E-commerce Page</title>
                ...
                <div class="col-md-8 offset-md-2 col-12">
                    <div class="search-form">
                        <form action="{{ url('search') }}" method="get">
                            ...
                            <select class="form-control" name="filter[product_name]">
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    <li class="cart-items">
                                        ...
                                        <div class="cart-content">
                                            ...
                                            <p>${{ $cart->relationtoproducttable->product_price * $cart->amount }}</p>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ URL::to('cart') }}" class="">Go To Cart</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
