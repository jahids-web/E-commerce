            ...
            <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                <div class="product-wrap">
                    ...
                    <div class="product-content">
                        <h3><a href="{{ route('product.show', $product->product_slug) }}">{{ $product->product_name }} | Cat: {{ App\Category::find($product->category_id)->categoty_name }}</a></h3>
